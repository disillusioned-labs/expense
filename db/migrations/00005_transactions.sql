...
(
    ...
    total_amount     BIGINT       NOT NULL DEFAULT 0, -- satuan terkecil; jangan pernah float
    currency         CHAR(3)      NOT NULL DEFAULT 'IDR',

    -- SNAPSHOT pembuat, dibekukan saat insert (id untuk menghubungkan, snapshot untuk menampilkan)
